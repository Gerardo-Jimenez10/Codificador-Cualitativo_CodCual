...
El Codificador Cualitativo está disponible listo para usar y descargar en la sección [`Releases`](./https://github.com/Gerardo-Jimenez10/Codificador-Cualitativo_CodCual/releases)  de este repositorio.
- **Ejecutable**
- **Manual de usuario**
